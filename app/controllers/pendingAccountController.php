...
class pendingAccountController extends Controller
{
	...
	public function index()
	{
		...
		if(isset($_SESSION['name']) && isset($_SESSION['username']) && isset($_SESSION['usertype'])) 
		{
			...
			$students = $object->pendingStudents();
			
			$this->controller->view()->render('admin/studentManagement/pendingAccount.php', $students);
		} 
		else 
		{
	...
	public function updateMultipleStatusToApproved()
	{
