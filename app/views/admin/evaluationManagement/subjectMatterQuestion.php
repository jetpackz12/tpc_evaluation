    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo ROOT; ?>subjectMatterQuestion/store" method="POST" class="postForm">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="exampleInputQuestion">Question</label>
                                    <textarea class="form-control" rows="3" id="exampleInputQuestion" name="question" placeholder="Enter Knowledge of the Subject Matter Question..." required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo ROOT; ?>subjectMatterQuestion/update" method="POST" class="postForm">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" id="e_question" name="question" placeholder="Enter Knowledge of the Subject Matter Question..." required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo ROOT; ?>subjectMatterQuestion/updateStatus" method="POST" class="postForm">
                    <div class="modal-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.editWithData').on('click', function() {
                const path = '<?php echo ROOT; ?>subjectMatterQuestion/edit';
