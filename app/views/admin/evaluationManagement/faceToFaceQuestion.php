...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo ROOT; ?>faceToFaceQuestion/store" method="POST" class="postForm">
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo ROOT; ?>faceToFaceQuestion/update" method="POST" class="postForm">
                    <div class="modal-body">
                        <div class="row">
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo ROOT; ?>faceToFaceQuestion/updateStatus" method="POST" class="postForm">
                    <div class="modal-body">
    ...
    <script>
        ...
        $("#faceToFaceQuestion").addClass("active");
        ...
        $(document).ready(function() {
            $('.editWithData').on('click', function() {
                const path = '<?php echo ROOT; ?>faceToFaceQuestion/edit';
