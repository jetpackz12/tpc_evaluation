                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"><span class="d-none d-sm-inline">List of </span>Approved Accounts</h3>
                                            ...
                                            <?php foreach ($data as $result) { ?>
                                                <tr>
                                                    <td>
                                                        <div class="icheck-primary">
                                                            <input type="checkbox" class="cb-input" name="cbInputVal[]"
                                                                id="checkbox<?php echo $result['id']; ?>"
                                                                value="<?php echo $result['id']; ?>">
                                                            <label for="checkbox<?php echo $result['id']; ?>">
                                                            </label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="d-flex justify-content-center align-items-center">
                                                        <form action="<?php echo ROOT; ?>approvedAccount/updateStatusToPending" class="postForm">
                                                            <input type="text" class="form-control" name="id" value="<?php echo $result['id']; ?>" hidden>
                                                            <button type="submit" class="btn btn-info mr-0 mr-sm-1 mb-1 mb-sm-0">
                                                                <i class="fa fa-hourglass-half mr-1"></i>
                                                                Pending
                                                            </button>
                                                            <button type="button" class="btn btn-danger edit"
                                                                data-id="<?php echo $result['id']; ?>" data-toggle="modal"
    ...
    <div class="modal fade" id="modal-cancel">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo ROOT; ?>approvedAccount/updateStatusToCancelled" method="POST" class="postForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="5" name="reason" placeholder="Enter reason..."></textarea>
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('#btn-pending-all').click(function() {
                ...
                $.ajax({
                    type: "POST",
                    cache: false,
                    url: "<?php echo ROOT; ?>approvedAccount/updateMultipleStatusToPending",
                    data: {
