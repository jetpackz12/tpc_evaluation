    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo ROOT; ?>categoryManagement/store" method="POST" class="postForm">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="exampleInputCategoryName">Category Name</label>
                                    <input type="text" class="form-control" id="exampleInputCategoryName" name="category_name" placeholder="Enter Category Name" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo ROOT; ?>categoryManagement/updateStatus" method="POST" class="postForm">
                    <div class="modal-body">
