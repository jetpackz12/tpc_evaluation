...
class faceToFaceModel extends model
{
    ...
    public function index($param = array())
	{
        ...
        $sql = "SELECT * FROM view_face_to_face_question";
	...
	public function store($param = array())
	{
        ...
        $sql = "INSERT INTO `tbl_question`(`category_id`, `modality_id`, `question`, `status`, `created_at`) VALUES ('".$category_name."','".$this->FACE_TO_FACE_MODALITY."','".$question."','".$this->ENABLED."','".$created_at."')";
	...
	public function update($param = array())
	{
        ...
        $sql = "UPDATE `tbl_question` SET `category_id`='".$category_name."',`question`='".$question."' WHERE id = ".$id."";
	...
	public function updateStatus($param = array())
	{
        ...
        $sql = "UPDATE `tbl_question` SET `status`='".$status."' WHERE id = ".$id."";
    ...
    public function retrieveAllData()
    {
        ...
        $sql = "SELECT * FROM view_face_to_face_question WHERE status = '$this->ENABLED'";
        $result = $this->con->query($sql);
        if($result->num_rows > 0)
        {
            while($row = $result->fetch_assoc()) {
